...
def generar_maqueta_v1(datos):
    """
    Genera el HTML/CSS para la Versión 1 (Diseño Original / One Page Scroll).
    [MAQUETA 1]
    """
    ...
    # Construcción del footer con iconos sociales siempre visibles
    ...
    <footer id="contacto" style="background: #181818; padding: 4rem 2rem; text-align: center; color: #aaa; font-size: 0.9rem;">
        ...
        <div class="social-icons">{instagram_icon_html}{facebook_icon_html}</div>
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .social-icon.active-link {{ cursor: pointer; }}
